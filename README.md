...
The <strong style="color: rgb(121, 121, 121);">NMR records</strong> (and the included [.sdf file](Sdf_files)) will be generated by computer-assisted structure elucidation software or web-based tools (see [partners of the initiative](partners) and the [list of compatible software](Compatible_software)).
